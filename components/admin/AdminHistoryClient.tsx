...
export function AdminHistoryClient({ bookings }: AdminHistoryClientProps) {
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-xs text-muted-foreground">Divalidasi</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="text-2xl font-bold text-green-600">{stats.approved}</div>
            <p className="text-xs text-muted-foreground">Disetujui Wadir</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
                              ...
                              {booking.validatedAt && (
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-xs">
                                    Divalidasi:{" "}
                                    {format(new Date(booking.validatedAt), "dd MMM yyyy, HH:mm", {
                                      locale: localeId,
                                    })}
                                  </span>
                                </div>
                          ...
                          <div className="flex flex-col items-center">
                            <div
                              className={`w-2 h-2 rounded-full ${
                                selectedBooking.status === "REJECTED" ? "bg-red-500" : "bg-blue-500"
                              }`}
                            />
